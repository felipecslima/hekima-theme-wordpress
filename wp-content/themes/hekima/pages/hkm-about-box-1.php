    ...
    <div class="content width-100 max-with-1240 padding-top-80">
        ...
        <div class="padding-bottom-64 margin-top-40 list">
            <div data-aos="fade-up" data-aos-delay="0">
                ...
                <h3 class="font-size-24 margin-top-32">Por trás da tecnologia e dos algoritmos, pessoas</h3>
                <p class="margin-top-20">
                    As soluções que criamos são feitas por pessoas, para as pessoas. Ao contrário do que muitos pensam,
                    IA não é perfeita. Na maioria das vezes, ela é mais sobre seres humanos do que sobre máquinas e
            ...
            <div data-aos="fade-up" data-aos-delay="100">
                ...
                <h3 class="font-size-24 margin-top-32">Em cada perspectiva, muitas possibilidades</h3>
                <p class="margin-top-20">
                    Acreditamos que a empatia produz diversidade, e diversidade produz riqueza de opiniões, modos de
                    fazer e formas de pensar. Essa nossa crença nos leva a compartilhar mais, colaborar mais e tomar
            ...
            <div data-aos="fade-up" data-aos-delay="150">
                ...
                <h3 class="font-size-24 margin-top-32">Queremos impactar nossos clientes e ir além</h3>
                <p class="margin-top-20">
                    Queremos mudar o mundo com o que fazemos. Ajudamos nossos clientes a alavancar vendas, diminuir
